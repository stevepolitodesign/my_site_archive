class Archive < ApplicationRecord
  ...
  private
    ...
    def limit_guest_user_archives
      errors.add(:base, "You've reached your free limit. Want unlimited access? Sign up today for a 30 day free trial today!") if self.user.present? && self.user.archives_count >= GUEST_USER_LIMIT
    end
end
